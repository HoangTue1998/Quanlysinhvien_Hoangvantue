...
insert into NhanVien values('tuedeptrai','123456','thaoongvang','tuehvph13476@fpt.edu.vn',0,0)
insert into NhanVien values('admin','admin','admin','admin@fpt.edu.vn',1,0)
